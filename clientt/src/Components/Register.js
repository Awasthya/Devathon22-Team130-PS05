...
const Register = () => {
    ...
    const postData = async (e) => {
        e.preventDefault();
        const { name, email, rollNo, course, type, phone, password, cpassword } = user;
        
        console.log(name, email, rollNo, course, type, phone, password, cpassword);
        const res = await fetch("/register", {
            ...
            body: JSON.stringify({
                name, email,rollNo, course, type,phone,password, cpassword
            })
        ...
        <form method="POST" className="register-form" id="register-form" action=''>
            ...
            <div className="form-group">
                <label for="email"></label>
                    ...
                    <option value = "Eletrician"> Electrician  
                    </option>  
                    </select>  
                    </div>
                    <div className="form-group">
